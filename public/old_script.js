...
const sendMessage = async (event) => {
    ...
    ? { input: messageData.message, id: participantID, botType: "baseline"} // First submission, send only input
    : { history: conversationHistory, input: messageData.message, id: participantID, botType: "baseline"};
